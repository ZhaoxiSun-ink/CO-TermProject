...
bool getInstructions(const char argc[], vector<string> &instructions, map<string, int> & branches){
    ifstream myfile;
    myfile.open("/Users/soushobun/Desktop/co/co_project/co_project/input05.txt");
                 ...
                 std::map<std::string,std::pair<int, int> > register_file)
{
    ...
    for(int i = 0; i < count; i++){
        std::cout << cycle_instructions[i] <<"\t";
        if (cycle_instructions[i].length() < 16) {
            cout << "\t";
        }
        for(int j = 0; j < 16; j++){
            if(j != 15){
    ...
    cout << "$s0 = " << register_file["s0"].first << " \t\t";
    cout << "$s1 = " << register_file["s1"].first << " \t\t";
    cout << "$s2 = " << register_file["s2"].first << " \t\t";
    cout << "$s3 = " << register_file["s3"].first << "\n";
    cout << "$s4 = " << register_file["s4"].first << " \t\t";
    cout << "$s5 = " << register_file["s5"].first << " \t\t";
    cout << "$s6 = " << register_file["s6"].first << " \t\t";
    cout << "$s7 = " << register_file["s7"].first << "\n";
    cout << "$t0 = " << register_file["t0"].first << " \t\t";
    cout << "$t1 = " << register_file["t1"].first << " \t\t";
    cout << "$t2 = " << register_file["t2"].first << " \t\t";
    cout << "$t3 = " << register_file["t3"].first << "\n";
    cout << "$t4 = " << register_file["t4"].first << " \t\t";
    cout << "$t5 = " << register_file["t5"].first << " \t\t";
    cout << "$t6 = " << register_file["t6"].first << " \t\t";
    cout << "$t7 = " << register_file["t7"].first << "\n";
    cout << "$t8 = " << register_file["t8"].first << " \t\t";
    cout << "$t9 = " << register_file["t9"].first << "\n";
    cout <<"----------------------------------------------------------------------------------\n";
}
...
int main(int argc, const char * argv[]) {
    ...
    if (!strncmp(argv[1], "F", 1)){
        ...
        for (int i = 0; i < 16; i++){
            for (int j = 0; j <= cycle_instructions.size(); j++){
                ...
                if (j==i){//only update the last instruction of this cycle, the previous instructions remain the same
                    ...
                    if (cycle_instructions.size()!=j+1){
                ...
                if (j==cycle_instructions.size()){//last instruction
                    break;
                }
                ...
                if (j == cycle_instructions.size()-1 && current_stage==5){
